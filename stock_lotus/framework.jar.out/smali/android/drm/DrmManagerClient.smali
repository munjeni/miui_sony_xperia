...
.method public static notify(Ljava/lang/Object;IILjava/lang/String;)V
    ...
    .line 199
    .local v1, instance:Landroid/drm/DrmManagerClient;
    if-eqz v1, :cond_0

    iget-object v3, v1, Landroid/drm/DrmManagerClient;->mInfoHandler:Landroid/drm/DrmManagerClient$InfoHandler;

    if-eqz v3, :cond_0

    .line 200
    new-instance v0, Landroid/drm/DrmInfoEvent;

    invoke-direct {v0, p1, p2, p3}, Landroid/drm/DrmInfoEvent;-><init>(IILjava/lang/String;)V

    .line 201
    .local v0, event:Landroid/drm/DrmInfoEvent;
    iget-object v3, v1, Landroid/drm/DrmManagerClient;->mInfoHandler:Landroid/drm/DrmManagerClient$InfoHandler;

    const/4 v4, 0x1

    invoke-virtual {v3, v4, v0}, Landroid/drm/DrmManagerClient$InfoHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {v3, v2}, Landroid/drm/DrmManagerClient$InfoHandler;->sendMessage(Landroid/os/Message;)Z

    .line 205
    .end local v0           #event:Landroid/drm/DrmInfoEvent;
...
.method private static notify(Ljava/lang/Object;IILjava/lang/String;Ljava/util/HashMap;)V
    ...
    invoke-direct {v0, p1, p2, p3, p4}, Landroid/drm/DrmInfoEvent;-><init>(IILjava/lang/String;Ljava/util/HashMap;)V
