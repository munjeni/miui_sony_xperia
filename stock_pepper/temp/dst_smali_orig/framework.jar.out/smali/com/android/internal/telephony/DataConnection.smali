...
.field protected static final ipv6FallbackFailCauses:Ljava/util/ArrayList;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/internal/telephony/DataConnection;->ipv6FallbackFailCauses:Ljava/util/ArrayList;
...
.method protected constructor <init>(Lcom/android/internal/telephony/PhoneBase;Ljava/lang/String;ILcom/android/internal/telephony/RetryManager;Lcom/android/internal/telephony/DataConnectionTracker;)V
    ...
    new-instance v1, Lcom/android/internal/telephony/DataConnection$DcDisconnectionErrorCreatingConnection;

    invoke-direct {v1, p0, v2}, Lcom/android/internal/telephony/DataConnection$DcDisconnectionErrorCreatingConnection;-><init>(Lcom/android/internal/telephony/DataConnection;Lcom/android/internal/telephony/DataConnection$1;)V

    iput-object v1, p0, Lcom/android/internal/telephony/DataConnection;->mDisconnectingErrorCreatingConnection:Lcom/android/internal/telephony/DataConnection$DcDisconnectionErrorCreatingConnection;
    ...
    invoke-direct {p0, v1}, Lcom/android/internal/telephony/DataConnection;->configureTempFailureCauses(Ljava/lang/String;)V

    const-string v1, "ro.net.ipv6_failures"
    ...
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/DataConnection;->configureIpv6FallbackFailureCauses(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/internal/telephony/DataConnection;->addState(Lcom/android/internal/util/State;)V
    ...
    invoke-virtual {p0, v1, v2}, Lcom/android/internal/telephony/DataConnection;->addState(Lcom/android/internal/util/State;Lcom/android/internal/util/State;)V
    ...
    iget-object v1, p0, Lcom/android/internal/telephony/DataConnection;->mDisconnectingErrorCreatingConnection:Lcom/android/internal/telephony/DataConnection$DcDisconnectionErrorCreatingConnection;
    ...
    invoke-virtual {p0, v1}, Lcom/android/internal/telephony/DataConnection;->setInitialState(Lcom/android/internal/util/State;)V
...
.method protected configureIpv6FallbackFailureCauses(Ljava/lang/String;)V
    .locals 9
    .parameter "configStr"

    .prologue
    sget-object v7, Lcom/android/internal/telephony/DataConnection;->ipv6FallbackFailCauses:Ljava/util/ArrayList;
    ...
    .local v6, strIpv6FallbackFailCausesArray:[Ljava/lang/String;
    array-length v7, v6
    ...
    const-string v8, "IPV6 fallback failure cause was not customized correctly."
