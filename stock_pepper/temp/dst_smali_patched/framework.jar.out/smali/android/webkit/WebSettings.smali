...
.field private mCanvasUsesAcceleratedDrawing:Z
...
.method constructor <init>(Landroid/content/Context;Landroid/webkit/WebView;)V
    ...
    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mSyncPending:Z

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mDestroyed:Z

    sget-object v1, Landroid/webkit/WebSettings$LayoutAlgorithm;->NARROW_COLUMNS:Landroid/webkit/WebSettings$LayoutAlgorithm;

    iput-object v1, p0, Landroid/webkit/WebSettings;->mLayoutAlgorithm:Landroid/webkit/WebSettings$LayoutAlgorithm;

    iput v6, p0, Landroid/webkit/WebSettings;->mTextSize:I

    const-string v1, "sans-serif"

    iput-object v1, p0, Landroid/webkit/WebSettings;->mStandardFontFamily:Ljava/lang/String;

    const-string v1, "monospace"

    iput-object v1, p0, Landroid/webkit/WebSettings;->mFixedFontFamily:Ljava/lang/String;

    const-string v1, "sans-serif"

    iput-object v1, p0, Landroid/webkit/WebSettings;->mSansSerifFontFamily:Ljava/lang/String;

    const-string v1, "serif"

    iput-object v1, p0, Landroid/webkit/WebSettings;->mSerifFontFamily:Ljava/lang/String;

    const-string v1, "cursive"

    iput-object v1, p0, Landroid/webkit/WebSettings;->mCursiveFontFamily:Ljava/lang/String;

    const-string v1, "fantasy"

    iput-object v1, p0, Landroid/webkit/WebSettings;->mFantasyFontFamily:Ljava/lang/String;
    ...
    iput v1, p0, Landroid/webkit/WebSettings;->mDefaultFontSize:I

    const/16 v1, 0xd

    iput v1, p0, Landroid/webkit/WebSettings;->mDefaultFixedFontSize:I

    iput v3, p0, Landroid/webkit/WebSettings;->mPageCacheCapacity:I

    iput-boolean v2, p0, Landroid/webkit/WebSettings;->mLoadsImagesAutomatically:Z

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mBlockNetworkImage:Z

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mJavaScriptEnabled:Z

    iput-boolean v2, p0, Landroid/webkit/WebSettings;->mAllowUniversalAccessFromFileURLs:Z

    iput-boolean v2, p0, Landroid/webkit/WebSettings;->mAllowFileAccessFromFileURLs:Z

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mHardwareAccelSkia:Z

    iput-boolean v2, p0, Landroid/webkit/WebSettings;->mCanvasUsesAcceleratedDrawing:Z

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mShowVisualIndicator:Z

    sget-object v1, Landroid/webkit/WebSettings$PluginState;->OFF:Landroid/webkit/WebSettings$PluginState;

    iput-object v1, p0, Landroid/webkit/WebSettings;->mPluginState:Landroid/webkit/WebSettings$PluginState;

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mJavaScriptCanOpenWindowsAutomatically:Z

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mUseDoubleTree:Z

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mUseWideViewport:Z

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mSupportMultipleWindows:Z

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mShrinksStandaloneImagesToFit:Z

    const-wide/16 v4, 0x0

    iput-wide v4, p0, Landroid/webkit/WebSettings;->mMaximumDecodedImageSize:J

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mPrivateBrowsingEnabled:Z

    iput-boolean v2, p0, Landroid/webkit/WebSettings;->mSyntheticLinksEnabled:Z

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mAppCacheEnabled:Z

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mDatabaseEnabled:Z

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mDomStorageEnabled:Z

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mWorkersEnabled:Z

    iput-boolean v2, p0, Landroid/webkit/WebSettings;->mGeolocationEnabled:Z

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mXSSAuditorEnabled:Z

    const-wide v4, 0x7fffffffffffffffL

    iput-wide v4, p0, Landroid/webkit/WebSettings;->mAppCacheMaxSize:J

    const-string v1, ""

    iput-object v1, p0, Landroid/webkit/WebSettings;->mAppCachePath:Ljava/lang/String;

    const-string v1, ""

    iput-object v1, p0, Landroid/webkit/WebSettings;->mDatabasePath:Ljava/lang/String;

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mDatabasePathHasBeenSet:Z

    const-string v1, ""

    iput-object v1, p0, Landroid/webkit/WebSettings;->mGeolocationDatabasePath:Ljava/lang/String;

    sget-object v1, Landroid/webkit/WebSettings$ZoomDensity;->MEDIUM:Landroid/webkit/WebSettings$ZoomDensity;

    iput-object v1, p0, Landroid/webkit/WebSettings;->mDefaultZoom:Landroid/webkit/WebSettings$ZoomDensity;

    sget-object v1, Landroid/webkit/WebSettings$RenderPriority;->NORMAL:Landroid/webkit/WebSettings$RenderPriority;

    iput-object v1, p0, Landroid/webkit/WebSettings;->mRenderPriority:Landroid/webkit/WebSettings$RenderPriority;

    const/4 v1, -0x1

    iput v1, p0, Landroid/webkit/WebSettings;->mOverrideCacheMode:I

    iput v6, p0, Landroid/webkit/WebSettings;->mDoubleTapZoom:I

    iput-boolean v2, p0, Landroid/webkit/WebSettings;->mSaveFormData:Z

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mAutoFillEnabled:Z

    iput-boolean v2, p0, Landroid/webkit/WebSettings;->mSavePassword:Z

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mLightTouchEnabled:Z

    iput-boolean v2, p0, Landroid/webkit/WebSettings;->mNeedInitialFocus:Z

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mNavDump:Z

    iput-boolean v2, p0, Landroid/webkit/WebSettings;->mSupportZoom:Z

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mBuiltInZoomControls:Z

    iput-boolean v2, p0, Landroid/webkit/WebSettings;->mDisplayZoomControls:Z

    iput-boolean v2, p0, Landroid/webkit/WebSettings;->mAllowFileAccess:Z

    iput-boolean v2, p0, Landroid/webkit/WebSettings;->mAllowContentAccess:Z

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mLoadWithOverviewMode:Z

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mEnableSmoothTransition:Z

    iput-boolean v3, p0, Landroid/webkit/WebSettings;->mForceUserScalable:Z

    iput-boolean v2, p0, Landroid/webkit/WebSettings;->mUseWebViewBackgroundForOverscroll:Z

    new-instance v1, Landroid/webkit/WebSettings$EventHandler;

    const/4 v4, 0x0

    invoke-direct {v1, p0, v4}, Landroid/webkit/WebSettings$EventHandler;-><init>(Landroid/webkit/WebSettings;Landroid/webkit/WebSettings$1;)V

    iput-object v1, p0, Landroid/webkit/WebSettings;->mEventHandler:Landroid/webkit/WebSettings$EventHandler;
    ...
    iput-object v1, p0, Landroid/webkit/WebSettings;->mDefaultTextEncoding:Ljava/lang/String;
    ...
    sput-object v1, Landroid/webkit/WebSettings;->sLockForLocaleSettings:Ljava/lang/Object;

    invoke-static {}, Ljava/util/Locale;->getDefault()Ljava/util/Locale;

    move-result-object v1

    sput-object v1, Landroid/webkit/WebSettings;->sLocale:Ljava/util/Locale;
    ...
    iput-object v1, p0, Landroid/webkit/WebSettings;->mUserAgent:Ljava/lang/String;

    iput-boolean v2, p0, Landroid/webkit/WebSettings;->mUseDefaultUserAgent:Z
    ...
    iput-object v1, p0, Landroid/webkit/WebSettings;->mUserAgentProfile:Ljava/lang/String;
    ...
    const-string v4, "ste.webkit.accelerated_canvas"
    ...
    .local v0, canvasUsesAcceleratedDrawing:Z
    :goto_1
    iget-boolean v1, p0, Landroid/webkit/WebSettings;->mCanvasUsesAcceleratedDrawing:Z

    if-eq v0, v1, :cond_1

    iput-boolean v0, p0, Landroid/webkit/WebSettings;->mCanvasUsesAcceleratedDrawing:Z
    ...
    .end local v0           #canvasUsesAcceleratedDrawing:Z
    :cond_2
    move v1, v3
...
.method public getProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    .prologue
    iget-boolean v0, p0, Landroid/webkit/WebSettings;->mDestroyed:Z
...
.method declared-synchronized onDestroyed()V
    ...
    :try_start_0
    iput-boolean v0, p0, Landroid/webkit/WebSettings;->mDestroyed:Z

    const/4 v0, 0x0

    iput-object v0, p0, Landroid/webkit/WebSettings;->mWebView:Landroid/webkit/WebView;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
